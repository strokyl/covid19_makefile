...
certificate.9a26dc6f.css: MIN_Interieur_RVB.57f44120.svg marianne-regular-webfont.daa94941.woff2
	curl https://media.interieur.gouv.fr/deplacement-covid-19/certificate.9a26dc6f.css | sed 's/\/deplacement-covid-19/./g' > $(CURDIR)/certificate.9a26dc6f.css

certificate.38b21110.js:
	curl https://media.interieur.gouv.fr/deplacement-covid-19/certificate.38b21110.js -o $(CURDIR)/certificate.38b21110.js
...
covid19.html: certificate.9a26dc6f.css certificate.38b21110.js incapsula_resource.js pdf_in_base64.js default.js
...
clean:
	rm $(CURDIR)/*.css $(CURDIR)/*.html $(CURDIR)/*.svg $(CURDIR)/default.js $(CURDIR)/pdf_in_base64.js $(CURDIR)/incapsula_resource.js $(CURDIR)/certificate.38b21110.js $(CURDIR)/*.woff2
